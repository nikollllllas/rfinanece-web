...
function BudgetCard({ budget, onDeleted }: { budget: any; onDeleted?: () => void }) {
    ...
    return (
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            {formatCurrency(Number(budget.amount))} • {formatPeriod(budget.period)}
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-2 text-xs text-muted-foreground flex justify-between">
            <span>Válido a partir de: {formatDate(budget.startDate.toString())}</span>
